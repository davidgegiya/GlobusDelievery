        ...
        <nav class="navbar navbar-expand-lg bg-light">
            <div class="container-fluid">
                <a class="navbar-brand" href="#">
                    <svg style="color: orange; width: 3em; height: 3em; margin-left: 2em"
                ...
                <div class="collapse navbar-collapse" id="navbarSupportedContent" style="margin-left: 2em; font-size: 1.5em">
                    <ul class="navbar-nav me-auto mb-2 mb-lg-0">
                        <li class="nav-item">
                            <a class="nav-link" aria-current="page" href="{{ route('user.showRestaurants') }}">Рестораны</a>
                        </li>
                        <li class="nav-item">
                            <a class="nav-link active" href="{{ route('user.cart') }}">Корзина</a>
                        </li>
                        <li class="nav-item">
